...
from deep_understand_flask.extensions import oid, facebook, twitter
from deep_understand_flask.models import db, User
from deep_understand_flask.forms import LoginForm, RegisterForm, OpenIDForm
